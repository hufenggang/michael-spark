...
public abstract class RpcHandler {
     ...
     * ({@link cn.michael.spark.network.client.StreamCallback#onData(String, ByteBuffer)})
     * will fail the entire channel.  A failure in "post-processing" the stream in
     * {@link cn.michael.spark.network.client.StreamCallback#onComplete(String)} will result in an
